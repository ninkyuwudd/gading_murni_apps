...
import {CustomerBottomTabNavigatorParamList} from '../../@types/navigation';
import {useTheme} from '@react-navigation/native';
import {Theme} from '../../@types/theme';
import {DashboardScreen} from '../../features/customers/dashboard';
import {SvgXml} from 'react-native-svg';
import {FONTS_FAMILIES, ICONS, SIZES} from '../../constants/theme';
import {useTranslation} from 'react-i18next';
import {useSafeAreaInsets} from 'react-native-safe-area-context';
import {ChatScreen} from '../../features/customers/chat';
...
const Tab = createBottomTabNavigator<CustomerBottomTabNavigatorParamList>();
    ...
    <Animated.View style={{flex: 1}}>
      <Tab.Navigator
        ...
        <Tab.Screen
          ...
          options={{
            tabBarLabel: t('BookingModule.TabBarBooking'),
            headerShown: false,
            tabBarIcon: ({color, size}) => (
              <SvgXml
        ...
        <Tab.Screen
          ...
          options={{
            tabBarLabel: t('ServiceModule.TabBarService'),
            headerShown: false,
            tabBarIcon: ({color, size}) => (
              <SvgXml
                xml={ICONS.navIcnService(color)}
                color={color}
                width={size}
                height={size}
              />
